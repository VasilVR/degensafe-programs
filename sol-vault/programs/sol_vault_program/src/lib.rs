...
// Solana enforces a 32-byte limit per PDA seed, making this the practical maximum
// for order_id length. Standardizing to 32 bytes saves on account rent costs.
