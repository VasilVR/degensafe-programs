...
describe("🔢 Stake Program - Multiple Pools per Token", () => {
  ...
  before(async () => {
    ...
    // Create two different reward mints
    const rewardMint1Keypair = anchor.web3.Keypair.generate();
    rewardMint1 = await createMint(
      provider.connection,
      admin.payer,
      admin.publicKey,
      null,
    ...
    console.log("✅ Reward mint 1 created:", rewardMint1.toBase58());
    console.log("✅ Reward mint 2 created:", rewardMint2.toBase58());
  });
